 ...
 * @author Rizal
 */
public class chaptervector extends javax.swing.JFrame {

    /**
     * Creates new form Vektor
     */
    public chaptervector() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addContainerGap(4078, Short.MAX_VALUE))
        );
...
//        new sumbu().grid(getGraphics());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new chaptervector().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(chaptervector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new chaptervector().setVisible(true);
                new chaptervector().setLocationRelativeTo(null);
            }
        });
    }
